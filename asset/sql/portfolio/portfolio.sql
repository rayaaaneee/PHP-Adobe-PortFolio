...
(1, 'Data-Analysis', 1, 'Data-Analysis.pbix', 0, NULL, 'data-analysis', NULL, 'Ce projet était un projet scolaire fait en groupe qui consistait à créer des graphiques (avec le logiciel Power BI) permettant de visualiser différents aspects d\'une base de données qui nous avait été donnée.', 'Lancez simplement le fichier à télécharger avec Power BI, vous pourrez alors voir la base de donnée utilisée ainsi que les graphiques crées.'),
(0, 'Graph-Analysis', 1, 'Graph-View.rar', 0, NULL, 'graph-analysis', NULL, 'Ce projet est un projet scolaire fait en groupe consistant à lire dans un fichier CSV différentes données qui représentent des villes (noeuds d\'un graphe), tout en travaillant avec ces données pour traiter le graphe de différents manières (l\'afficher, recuperer les noeuds voisins d\'un noeud en particulier, avoir le plus court chemin entre deux noeuds) \r\n', 'Il vous faut java d\'installé sur votre machine. Compilez les fichiers depuis le fichier Main.java puis vous pourrez executer le programme. Avec l\'interface graphique, il vous suffit de suivre les instructions.'),
(2, 'E-Ticket', 0, '', 1, 'e-ticket/', 'ticketing', NULL, 'Ce site est un projet scolaire de vente de tickets (concerts, spectacles ...).', 'Utilisation du php pour la connection à la base de données. Inscription, connection et administration de son compte possible.\r\nReception du billet en PDF par mail à la suite d\'un achat.'),
(3, 'Annuaire', 1, 'phone-book.rar', 0, NULL, 'phone-book', NULL, 'Ce projet de groupe du 1er semestre est un programme en C lisant un fichier CSV dont chaque ligne est un contact (décrit par un Nom, Prenom, Numéro, ...).\r\nLe but étant avec ce programme de pouvoir créer, supprimer, rechercher un contact selon une ou plusieurs informations, ainsi que de pouvoir trier les résultats selon un des attributs des contacts.', 'Le programme est sous forme de terminal. Il suffira simplement de suivre les instructions pour faire l\'action souhaité.'),
(4, 'Poster : Hack', 0, 'Project-Poster.pdf', 1, 'Project-Poster.pdf', 'poster', NULL, 'Ce projet était un projet scolaire de groupe de communication sur un sujet de notre choix en lien avec l\'informatique.\r\nJ\'ai travaillée sur la réalisation du design global du poster avec Photoshop et Illustrator (pour les formes), j\'ai donc trouvé interessant de l\'afficher dans les projets', NULL),
(7, 'Would You Play', 0, 'would-you-play/', 0, NULL, 'snake', NULL, 'Would you play est un projet personnel que j\'ai fait basé sur le HTML et le Javascript. Ce site (monopage) vous permet de jouer à différents jeux.', 'Séléctionner le jeu voulu (le Sticks game est encore en développement, seul le snake marche pour l\'instant). \r\nChargez le jeu puis choisissez d\'ignorer les instructions ou non. Le jeu apparait ensuite. Vous avez une page des préférences du jeu vous permettant de personnaliser votre mode de jeu, ces paramètres sont stockés avec des cookies permettant de les garder en mémoire (pendant une journée) et des les garder même avec un rechargement de page.\r\nAttention : Il arrive rarement que les instructions ne s\'affichent pas après avoir appuyé sur play ce qui bloque la page. Il suffit normalement de recharger la page pour règler cette erreur.'),
(6, 'Tree Viewer', 1, 'tree-viewer.rar', 0, NULL, 'tree', NULL, 'Tree Viewer est un projet visant à créer un ABR (Arbre binaire de recherche) et pouvoir le visualiser principalement, et d\'autres fonctionnalités.', 'Lancer le fichier exe de l\'application et suivez les instructions !'),
(5, 'GIT Cheat Sheet', 1, 'Git-Cheat-Sheet.pdf', 1, 'Git-Cheat-Sheet.pdf', 'git', NULL, 'Cet aide mémoire était un projet scolaire de groupe. Dans celui-ci , vous y verrez les commandes git les plus importantes ainsi que leur explication.', NULL),
(8, 'HTML CV', 1, 'cv-html.rar', 1, 'cv-html/', 'cv-html', NULL, 'Ce projet scolaire personnel a été fait en cours de Web au premier semestre du BUT1, basé uniquement sur le HTML et CSS. Les informations contenues dans celui-ci ne sont pas à jour.\r\nLe but principal de ce projet était de pouvoir travailler sur le positionnement css ainsi que les animations CSS.', NULL),

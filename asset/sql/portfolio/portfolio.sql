...
--
-- Hôte : localhost
-- Généré le : mar. 21 fév. 2023 à 21:20
...
INSERT INTO `message` (`name`, `email`, `content`, `date`, `time`) VALUES
('aha', 'rayane.merlin8@gmail.com', 'pd\r\n', '2023-02-21', '20:37:09'),
('aha', 'rayane.merlin8@gmail.com', 'pd\r\n', '2023-02-21', '20:39:44'),
('aha', 'rayane.merlin8@gmail.com', 'pd\r\n', '2023-02-21', '20:39:47');
...
(1, 'Annuaire', 'phone-book', 'Le programme est sous forme de terminal. Il suffira simplement de suivre les instructions pour faire l\'action souhaité.', 'Ce projet de groupe du 1er semestre est un programme en C lisant un fichier CSV dont chaque ligne est un contact (décrit par un Nom, Prenom, Numéro, ...).\r\nLe but étant avec ce programme de pouvoir créer, supprimer, rechercher un contact selon une ou plusieurs informations, ainsi que de pouvoir trier les résultats selon un des attributs des contacts.', 1, 'phone-book.rar', 0, NULL, NULL),
...
(4, 'Poster : Hack', 'poster', NULL, 'Ce projet était un projet scolaire de groupe de communication sur un sujet de notre choix en lien avec l\'informatique.\r\nJ\'ai travaillée sur la réalisation du design global du poster avec Photoshop et Illustrator (pour les formes).', 1, 'Project-Poster.pdf', 1, 'Project-Poster.pdf', NULL),
